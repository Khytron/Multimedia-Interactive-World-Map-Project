...
const mapPaths = {
    // North America
    northAmerica: {
        path: `M 50 50 Q 80 40 110 45 L 140 30 L 180 35 L 240 25 L 280 30 L 270 80 Q 250 100 230 80 L 210 100 L 220 140 L 260 130 L 270 160 L 260 190 L 230 200 L 210 240 L 180 260 L 150 270 L 120 275 L 100 265 L 80 240 L 60 210 L 40 180 L 30 140 L 40 100 L 20 60 Z /* Mainland */
               M 180 40 Q 200 30 220 40 L 210 60 L 190 55 Z /* Baffin Island */
               M 260 40 L 290 30 L 300 60 L 280 70 Z /* Greenland */
               M 100 260 L 120 270 L 110 280 L 90 270 Z /* Cuba/Caribbean */`,
        name: 'North America',
        class: 'north-america'
    },
    ...
    // South America
    southAmerica: {
        path: `M 150 270 Q 180 265 210 275 L 250 290 L 290 310 Q 320 330 310 370 Q 300 410 290 450 L 270 500 L 240 550 L 220 580 L 200 560 L 190 520 L 180 480 L 170 440 L 160 400 L 150 350 L 140 310 L 150 270 Z`,
        name: 'South America',
        class: 'south-america'
    },
    ...
    // Europe
    europe: {
        path: `M 400 120 L 420 100 L 440 90 L 470 85 L 500 80 L 530 85 L 550 100 L 560 120 L 550 140 L 530 150 L 510 160 L 490 165 L 470 160 L 460 150 L 450 140 L 430 130 L 410 125 Z /* Mainland */
               M 380 90 L 400 85 L 410 100 L 390 110 Z /* UK/Ireland */
               M 450 150 L 460 170 L 470 160 Z /* Italy */
               M 500 80 L 520 70 L 530 90 L 510 100 Z /* Scandinavia */
               M 355 70 Q 365 65 375 70 Q 378 78 370 82 Q 360 85 355 78 Q 352 74 355 70 Z /* Iceland */`,
        name: 'Europe',
        class: 'europe'
    },
    ...
    // Africa  
    africa: {
        path: `M 400 200 Q 450 190 500 200 L 540 210 L 570 240 L 580 280 L 570 330 L 550 380 L 530 430 L 500 480 L 460 490 L 430 470 L 400 440 L 380 400 L 370 350 L 380 300 L 390 250 L 400 200 Z
               M 565 435 Q 575 430 580 440 Q 578 460 570 465 Q 560 460 562 445 Z /* Madagascar */`,
        name: 'Africa',
        class: 'africa'
    },
